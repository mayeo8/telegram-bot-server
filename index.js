...
app.listen(PORT, () => {
  ...
  console.log(`Webhook endpoint: https://your-domain/telegram`);
  console.log(`Health check: https://your-domain/health`);
  console.log(`Setup webhook: https://your-domain/setup-webhook?url=https://your-domain`);
});
